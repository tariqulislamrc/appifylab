            ...
            <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
                <div className="container _custom_container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarContent">
                        ...
                        {/* Profile dropdown */}
                        <div className="_header_nav_profile" ref={dropRef} style={{ position: 'relative' }}>
                            <div className="_header_nav_profile_image">
                                <img src={avatarSrc} alt={fullName} className="_nav_profile_img" />
                            </div>
                            <div
                                ...
                                <div className="_nav_profile_dropdown _profile_dropdown show">
                                    <div className="_nav_profile_dropdown_info">
                                        <div className="_nav_profile_dropdown_image">
                                            <img src={avatarSrc} alt={fullName} className="_nav_drop_img" />
                                        </div>
