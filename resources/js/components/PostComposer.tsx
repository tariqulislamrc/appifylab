            ...
            <form onSubmit={handleSubmit}>
                <div className="_feed_inner_text_area_box">
                    <div className="_feed_inner_text_area_box_image">
                        <img src={avatarSrc} alt="" className="_txt_img" />
                    </div>
                    <div className="form-floating _feed_inner_text_area_box_form">
                        ...
                        />
                        <label className="_feed_textarea_label" htmlFor="postBody">
                            Write something...{' '}
                ...
                <div className="_feed_inner_text_area_bottom">
                    <div className="_feed_inner_text_area_item">
                        ...
                        {/* Private checkbox */}
                        <div className="_feed_common ms-2 d-flex align-items-center gap-1" style={{ fontSize: 13, color: '#666' }}>
                            <input
                                type="checkbox"
                                id="makePrivate"
                                checked={isPrivate}
                            ...
                            />
                            <label htmlFor="makePrivate" style={{ cursor: 'pointer', marginBottom: 0 }}>
                                Private
                            </label>
                        </div>
                    </div>
